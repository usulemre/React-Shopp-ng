              ...
              <ListGroup.Item key={item._id}>
                <Row className="align-items-center">
                  ...
                  <Col xs={4} sm={2} md={3}>
                    ...
                    <div className="d-block d-sm-none"> {/* Küçük ekranlarda sadece görünsün */}
                      {item.price}TL
                    </div>
                  </Col>
                  <Col xs={4} sm={3} md={2}>
                    <div className="d-flex align-items-center">
                      <Button
                        onClick={() => updateCartHanle(item, item.quantity - 1)}
                        variant="light"
                        size="sm"
                  ...
                  <Col sm={2} className="d-none d-sm-block"> {/* Küçük ekranlarda görünmüyor */}
                    {item.price}TL
                  </Col>
                  <Col xs={4} sm={2} className=""> {/* Küçük ekranlarda boşluk eklemek için */}
                    <Button
                      variant="light"
                      size="sm"
          ...
          <Card>
            <Card.Body>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Button disabled={cartItems.length === 0} variant="primary" className="btn-warning w-100">
                    Odeme
                  </Button>
                </ListGroup.Item>
              </ListGroup>
